...
,
  ...
  ghanaReadiness: ['tax', 'ghana', 'readiness'],
  taxCatalogProfiles: (qs) => ['tax', 'catalogProfiles', qs ?? {}],
  taxLedger: (qs) => ['tax', 'ledger', qs ?? {}],
  taxCodes: (qs) => ['tax', 'codes', qs ?? {}],
  taxJurisdictions: ['tax', 'jurisdictions'],
  partnerTaxProfiles: (qs) => ['tax', 'partnerProfiles', qs ?? {}],
  ghanaWithholdingRates: ['tax', 'ghana', 'withholding', 'rates'],
  ghanaWithholdingDashboard: (qs) => ['tax', 'ghana', 'withholding', 'dashboard', qs ?? {}],
  ghanaWithholdingReconciliation: (qs) => ['tax', 'ghana', 'withholding', 'reconciliation', qs ?? {}],
  ghanaWithholdingThresholdPosition: (qs) => ['tax', 'ghana', 'withholding', 'threshold', qs ?? {}],
  ghanaWithholdingEvents: (qs) => ['tax', 'ghana', 'withholding', 'events', qs ?? {}],
  ghanaWithholdingCertificates: (qs) => ['tax', 'ghana', 'withholding', 'certificates', qs ?? {}],
  ghanaWithholdingReturns: (qs) => ['tax', 'ghana', 'withholding', 'returns', qs ?? {}],
  ghanaWithholdingReturn: (id) => ['tax', 'ghana', 'withholding', 'returns', id],
  ghanaWithholdingRemittances: (qs) => ['tax', 'ghana', 'withholding', 'remittances', qs ?? {}],
  ghanaVatRegistrationMonitor: (qs) => ['tax', 'ghana', 'vat', 'registrationMonitor', qs ?? {}],
  ghanaVatReturn: (qs) => ['tax', 'ghana', 'vat', 'return', qs ?? {}],
  ghanaVatTransactions: (qs) => ['tax', 'ghana', 'vat', 'transactions', qs ?? {}],
  ghanaVatReconciliation: (qs) => ['tax', 'ghana', 'vat', 'reconciliation', qs ?? {}],
  ghanaVatApportionments: (qs) => ['tax', 'ghana', 'vat', 'apportionments', qs ?? {}],
  ghanaImportedServices: (qs) => ['tax', 'ghana', 'vat', 'importedServices', qs ?? {}],
  ghanaImportedService: (id) => ['tax', 'ghana', 'vat', 'importedServices', id],
  ghanaImportedServicesSummary: (qs) => ['tax', 'ghana', 'vat', 'importedServicesSummary', qs ?? {}],
