...
export const endpoints = {
  ...
  accounting: {
    ...
    tax: {
      ...
      countryPackInstall: `/core/accounting/tax/country-packs/install`,
      ghanaSetupChecklist: `/core/accounting/tax/ghana/setup-checklist`,
      ghanaDiagnostics: `/core/accounting/tax/ghana/diagnostics`,
      ghanaCalculate: `/core/accounting/tax/ghana/calculate`,
      ghanaInstallWorkflows: `/core/accounting/tax/ghana/install-workflows`,
  ...
  modules: {
    ...
    transactions: {
      invoices: {
        ...
        update: (id) => `/modules/transactions/invoices/${id}`,
      ...
      bills: {
        ...
        update: (id) => `/modules/transactions/bills/${id}`,
        submitForApproval: (id) =>
      ...
      customerReceipts: {
        ...
        update: (id) => `/modules/transactions/customer-receipts/${id}`,
        submitForApproval: (id) =>
      ...
      vendorPayments: {
        ...
        update: (id) => `/modules/transactions/vendor-payments/${id}`,
        submitForApproval: (id) =>
      ...
      creditNotes: {
        ...
        update: (id) => `/modules/transactions/credit-notes/${id}`,
        submitForApproval: (id) =>
      ...
      debitNotes: {
        ...
        update: (id) => `/modules/transactions/debit-notes/${id}`,
        submitForApproval: (id) =>
      ...
      quotations: {
        ...
        update: (id) => `/modules/transactions/quotations/${id}`,
      ...
      salesOrders: {
        ...
        update: (id) => `/modules/transactions/sales-orders/${id}`,
      ...
      purchaseRequisitions: {
        ...
        update: (id) => `/modules/transactions/purchase-requisitions/${id}`,
      ...
      purchaseOrders: {
        ...
        update: (id) => `/modules/transactions/purchase-orders/${id}`,
      ...
      goodsReceipts: {
        ...
        update: (id) => `/modules/transactions/goods-receipts/${id}`,
      ...
      expenses: {
        ...
        update: (id) => `/modules/transactions/expenses/${id}`,
      ...
      pettyCash: {
        ...
        update: (id) => `/modules/transactions/petty-cash/${id}`,
      ...
      advances: {
        ...
        update: (id) => `/modules/transactions/advances/${id}`,
      ...
      returns: {
        ...
        update: (id) => `/modules/transactions/returns/${id}`,
      ...
      refunds: {
        ...
        update: (id) => `/modules/transactions/refunds/${id}`,
