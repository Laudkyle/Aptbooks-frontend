      ...
      <div className="space-y-6">
        ...
        <ContentCard>
          <div className="flex items-center justify-center py-12">
            <div className="text-sm text-text-muted">Loading credit note details...</div>
          </div>
        </ContentCard>
      </div>
    );
      ...
      <div className="space-y-6">
        ...
        <ContentCard>
          <div className="flex flex-col items-center justify-center py-12 gap-3">
            ...
            <div className="text-sm font-medium text-text-strong">Failed to load credit note</div>
            <div className="text-sm text-text-muted">{error?.message ?? 'Credit note not found'}</div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <ContentCard>
            <div className="flex items-start justify-between gap-4 mb-6">
              <div>
                <div className="text-base font-semibold text-text-strong">Credit Note Summary</div>
                <div className="mt-1 text-sm text-text-muted">Customer credit and transaction details</div>
              </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-xl border border-border-subtle bg-surface-2 p-4">
                ...
                <div className="text-sm font-semibold text-text-strong">{customerName}</div>
                {note.customer_code && (
                  <div className="text-xs text-text-muted mt-1">Code: {note.customer_code}</div>
                )}
              </div>
              ...
              <div className="rounded-xl border border-border-subtle bg-surface-2 p-4">
                ...
                <div className="text-sm font-semibold text-text-strong">{formatDate(creditNoteDate)}</div>
              </div>
          ...
          {(note.customer_email || note.customer_phone) && (
            <ContentCard>
              <div className="text-base font-semibold text-text-strong mb-4">Customer Contact Information</div>
              <div className="grid gap-4 md:grid-cols-2">
                {note.customer_email && (
                  <div className="rounded-xl border border-border-subtle bg-surface-2 p-4">
                    <div className="flex items-center gap-2 text-xs font-medium text-text-muted mb-2">
          ...
          {applications.length > 0 && (
            <ContentCard>
              <div className="text-base font-semibold text-text-strong mb-4">Invoice Applications</div>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-surface-2 border-b border-border-subtle">
                    <tr>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 text-xs">
                <div className={`mt-0.5 h-5 w-5 rounded-full flex items-center justify-center flex-shrink-0 ${
                  canIssue ? 'bg-green-100 text-green-600' : 'bg-surface-2 text-text-soft'
                }`}>
                  1
                </div>
                <div>
                  <div className="font-medium text-text-body">Issue credit note</div>
                  <div className="text-text-muted mt-0.5">Make the credit available for use</div>
                </div>
              </div>
              <div className="flex items-start gap-3 text-xs">
                <div className={`mt-0.5 h-5 w-5 rounded-full flex items-center justify-center flex-shrink-0 ${
                  canApply ? 'bg-green-100 text-green-600' : 'bg-surface-2 text-text-soft'
                }`}>
                  2
                </div>
                <div>
              ...
              <div className="flex items-start gap-3 text-xs">
                ...
                <div>
                  ...
                  <div className="text-text-muted mt-0.5">Cancel the credit note</div>
                </div>
              </div>
            </div>
          </ContentCard>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-border-subtle bg-surface-2 p-4">
            <div className="grid gap-2 text-sm">
              <div className="flex justify-between">
                <span className="text-text-muted">Credit Note Number</span>
