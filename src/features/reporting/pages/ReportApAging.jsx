    ...
    <div className="max-w-[1400px] mx-auto space-y-6 pb-8">
      ...
      {summary && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="bg-surface-1 border border-border-subtle rounded-lg p-4">
            <p className="text-xs font-medium text-text-muted mb-1">Total Vendors</p>
            <p className="text-2xl font-bold text-text-strong">{summary.totalVendors}</p>
          </div>
          <div className="bg-surface-1 border border-border-subtle rounded-lg p-4">
        ...
        {isLoading ? (
          ...
          <>
            <div className="mb-4 flex items-center justify-between">
              <div>
                <h3 className="text-sm font-semibold text-text-strong">Vendor Details</h3>
      ...
      <ContentCard>
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-text-strong">About AP Aging</h3>
          <div className="grid md:grid-cols-2 gap-4 text-sm text-text-body">
            <div>
              <h4 className="font-medium text-text-strong mb-2">What is AP Aging?</h4>
