...
export default function ReportArAging() {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `ar-aging-${asOfDate || new Date().toISOString().split('T')[0]}.csv`;
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="text-sm text-blue-800">
                    Viewing receivables as of <span className="font-semibold">{new Date(asOfDate).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
                  </p>
                </div>
              </div>
            </div>
