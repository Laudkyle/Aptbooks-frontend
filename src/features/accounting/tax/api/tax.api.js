...
export function makeTaxApi(http) {
  return {
    ...
    installCountryPack: async (body) => (await http.post(endpoints.accounting.tax.countryPackInstall, body, { headers: ensureIdempotencyKey() })).data,
    getGhanaSetupChecklist: async () => (await http.get(endpoints.accounting.tax.ghanaSetupChecklist)).data?.data ?? {},
    getGhanaDiagnostics: async () => (await http.get(endpoints.accounting.tax.ghanaDiagnostics)).data?.data ?? {},
    calculateGhanaTax: async (body) => (await http.post(endpoints.accounting.tax.ghanaCalculate, body)).data?.data ?? {},
    installGhanaWorkflows: async () => (await http.post(endpoints.accounting.tax.ghanaInstallWorkflows, {}, { headers: ensureIdempotencyKey() })).data?.data ?? {},
    ...
    getVatSummary: async (qs) => (await http.get(endpoints.reporting.tax.vatSummary(qs))).data?.data ?? {},
    getVatReturn: async (qs) => (await http.get(endpoints.reporting.tax.vatReturn(qs))).data?.data ?? {},
    createVatReturn: async (body) => (await http.post(endpoints.reporting.tax.createVatReturn, body, { headers: ensureIdempotencyKey() })).data?.data ?? {},
    getGhanaVatReturn: async (qs) => (await http.get(endpoints.reporting.tax.ghanaVatReturn(qs))).data?.data ?? {},
    getGhanaVatTransactions: async (qs) => (await http.get(endpoints.reporting.tax.ghanaVatTransactions(qs))).data?.data ?? [],
    getGhanaVatReconciliation: async (qs) => (await http.get(endpoints.reporting.tax.ghanaVatReconciliation(qs))).data?.data ?? {},
    getTaxTransactions: async (qs) => (await http.get(endpoints.reporting.tax.transactions(qs))).data?.data ?? [],
    getTaxReconciliation: async (qs) => (await http.get(endpoints.reporting.tax.reconciliation(qs))).data?.data ?? {},
    getRecoverability: async (qs) => (await http.get(endpoints.reporting.tax.recoverability(qs))).data?.data ?? [],
    getWithholdingSummary: async (qs) => (await http.get(endpoints.reporting.tax.withholdingSummary(qs))).data?.data ?? {},
    getWithholdingPayable: async (qs) => (await http.get(endpoints.reporting.tax.withholdingPayable(qs))).data?.data ?? {},
    getWithholdingReceivable: async (qs) => (await http.get(endpoints.reporting.tax.withholdingReceivable(qs))).data?.data ?? {},
    getWithholdingOpenItems: async (qs) => (await http.get(endpoints.reporting.tax.withholdingOpenItems(qs))).data?.data ?? {},
    getWithholdingReconciliation: async (qs) => (await http.get(endpoints.reporting.tax.withholdingReconciliation(qs))).data?.data ?? {},
    getTaxDiagnosticsReport: async (qs) => (await http.get(endpoints.reporting.tax.diagnostics(qs))).data?.data ?? [],
