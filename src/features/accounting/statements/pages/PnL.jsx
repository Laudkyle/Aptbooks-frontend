...
export default function PnL() {
  ...
  const q = useQuery({
    ...
    queryFn: () => api.incomeStatement({ periodId, comparePeriodId: comparePeriodId || undefined, mode: mode || undefined }),
    enabled: !!periodId
  });
  ...
  return (
    <div className="space-y-4">
      <PageHeader title="Income Statement (P&L)" subtitle="Rendered by the backend statement engine." />
      <FilterBar>
        ...
        <Input placeholder="mode (optional)" value={mode} onChange={(e) => setMode(e.target.value)} />
      </FilterBar>
