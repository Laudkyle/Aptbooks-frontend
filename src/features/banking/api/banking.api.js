...
export function makeBankingApi(http) {
  return {
    ...
    listPaymentRuns(params) {
      return http.get(`/modules/banking/payment-runs${qs(params)}`).then((r) => r.data);
    },
    getPaymentRun(id) {
      return http.get(`/modules/banking/payment-runs/${id}`).then((r) => r.data);
    },
    createPaymentRun(payload) {
      return http.post('/modules/banking/payment-runs', payload, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    addPaymentRunLines(id, payload) {
      return http.post(`/modules/banking/payment-runs/${id}/lines`, payload, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    submitPaymentRun(id) {
      return http.post(`/modules/banking/payment-runs/${id}/submit`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    approvePaymentRun(id) {
      return http.post(`/modules/banking/payment-runs/${id}/approve`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    executePaymentRun(id) {
      return http.post(`/modules/banking/payment-runs/${id}/execute`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    cancelPaymentRun(id, payload) {
      return http.post(`/modules/banking/payment-runs/${id}/cancel`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },

    listBankTransfers(params) {
      return http.get(`/modules/banking/bank-transfers${qs(params)}`).then((r) => r.data);
    },
    getBankTransfer(id) {
      return http.get(`/modules/banking/bank-transfers/${id}`).then((r) => r.data);
    },
    createBankTransfer(payload) {
      return http.post('/modules/banking/bank-transfers', payload, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    submitBankTransfer(id) {
      return http.post(`/modules/banking/bank-transfers/${id}/submit`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    approveBankTransfer(id) {
      return http.post(`/modules/banking/bank-transfers/${id}/approve`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    postBankTransfer(id) {
      return http.post(`/modules/banking/bank-transfers/${id}/post`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    cancelBankTransfer(id, payload) {
      return http.post(`/modules/banking/bank-transfers/${id}/cancel`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },

    listApprovalBatches() {
      return http.get('/modules/banking/approval-batches').then((r) => r.data);
    },
    getApprovalBatch(id) {
      return http.get(`/modules/banking/approval-batches/${id}`).then((r) => r.data);
    },
    createApprovalBatch(payload) {
      return http.post('/modules/banking/approval-batches', payload, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    addApprovalBatchItems(id, payload) {
      return http.post(`/modules/banking/approval-batches/${id}/items`, payload, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    submitApprovalBatch(id) {
      return http.post(`/modules/banking/approval-batches/${id}/submit`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    approveApprovalBatch(id) {
      return http.post(`/modules/banking/approval-batches/${id}/approve`, {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    cancelApprovalBatch(id, payload) {
      return http.post(`/modules/banking/approval-batches/${id}/cancel`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },

    listCheques(params) {
      return http.get(`/modules/banking/cheques${qs(params)}`).then((r) => r.data);
    },
    getCheque(id) {
      return http.get(`/modules/banking/cheques/${id}`).then((r) => r.data);
    },
    createCheque(payload) {
      return http.post('/modules/banking/cheques', payload, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    issueCheque(id, payload) {
      return http.post(`/modules/banking/cheques/${id}/issue`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    clearCheque(id, payload) {
      return http.post(`/modules/banking/cheques/${id}/clear`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    voidCheque(id, payload) {
      return http.post(`/modules/banking/cheques/${id}/void`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },
    bounceCheque(id, payload) {
      return http.post(`/modules/banking/cheques/${id}/bounce`, payload ?? {}, { headers: ensureIdempotencyKey() }).then((r) => r.data);
    },

    getCashForecast(params) {
      return http.get(`/modules/banking/cash-forecast${qs(params)}`).then((r) => r.data);
    },
    listCashForecastSnapshots() {
      return http.get('/modules/banking/cash-forecast/snapshots').then((r) => r.data);
    },
