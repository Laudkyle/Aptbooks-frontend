  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-surface-1 border border-border-subtle rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-text-muted">Total Keys</p>
              <p className="text-3xl font-bold text-text-strong mt-2">{keys.length}</p>
            </div>
        ...
        <div className="bg-surface-1 border border-border-subtle rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-text-muted">Active Keys</p>
        ...
        <div className="bg-surface-1 border border-border-subtle rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-text-muted">Revoked Keys</p>
              <p className="text-3xl font-bold text-text-soft mt-2">{revokedKeys.length}</p>
            </div>
            <div className="w-12 h-12 bg-surface-2 rounded-lg flex items-center justify-center">
              <svg className="w-6 h-6 text-text-soft" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <ContentCard>
        ...
        {/* Filter Tabs */}
        <div className="mb-6 flex items-center justify-between border-b border-border-subtle">
            ...
            <Table>
              ...
              <TBody>
                {filteredKeys.map((key) => (
                  <tr key={key.id} className="hover:bg-surface-2">
                    <TD>
                    ...
                    <TD>
                      <code className="px-2 py-1 bg-surface-2 text-text-strong rounded text-xs font-mono">
                        {key.prefix}...
                      </code>
                    </TD>
                    <TD>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-surface-2 border border-border-subtle rounded-lg p-4 space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-text-strong">{revokeConfirm.name}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-text-muted">Key Prefix:</span>
                <code className="font-mono text-text-strong">{revokeConfirm.prefix}...</code>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-text-muted">Created:</span>
                <span className="text-text-strong">{formatDate(revokeConfirm.created_at)}</span>
              </div>
            </div>
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-surface-2 border border-border-subtle rounded-lg p-4">
          <h4 className="text-sm font-semibold text-text-strong mb-3">Best Practices</h4>
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="bg-surface-2 border border-border-subtle rounded-lg p-4">
          <h4 className="text-sm font-semibold text-text-strong mb-3">Next Steps</h4>
