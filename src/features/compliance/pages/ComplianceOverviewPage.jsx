      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            <Button asChild variant="outline"><a href="/compliance/ifrs16">IFRS 16</a></Button>
            <Button asChild variant="outline"><a href="/compliance/ifrs15">IFRS 15</a></Button>
            <Button asChild variant="outline"><a href="/compliance/ifrs9">IFRS 9</a></Button>
            <Button asChild variant="outline"><a href="/compliance/ias12">IAS 12</a></Button>
          </div>
        }
      />
