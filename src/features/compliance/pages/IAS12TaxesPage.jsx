  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Authorities, rate sets, temporary differences, deferred tax runs."
        actions={
          <div className="flex flex-wrap gap-2">
            <Button variant="default">New authority</Button>
            <Button variant="outline">Import temp differences</Button>
            <Button variant="outline">Compute deferred tax</Button>
          </div>
        }
      />
