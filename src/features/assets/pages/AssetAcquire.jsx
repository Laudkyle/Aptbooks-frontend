...
export default function AssetAcquire() {
  ...
  async function onSubmit(e) {
    ...
    setSaving(true);
    try {
      const payload = { periodId: form.periodId, entryDate: form.entryDate, fundingAccountId: form.fundingAccountId, memo: form.memo || undefined };
      await assetsApi.acquireFixedAsset(id, payload);
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Capitalise the asset (posts GL entry)."
        actions={
