...
export default function AssetRevalue() {
  ...
  async function onSubmit(e) {
    ...
    setSaving(true);
    try {
      const payload = { periodId: form.periodId, entryDate: form.entryDate, newValue: String(form.newValue || '0').trim(), revaluationReserveAccountId: form.revaluationReserveAccountId, memo: form.memo || undefined };
...
<AccountSelect label="Revaluation reserve account" value={form.revaluationReserveAccountId} onChange={(e)=>setForm(s=>({...s, revaluationReserveAccountId:e.target.value}))} required />
