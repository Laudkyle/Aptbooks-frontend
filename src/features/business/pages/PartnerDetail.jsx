...
export default function PartnerDetail() {
  ...
  React.useEffect(() => {
    ...
    setTax({
      taxIdNumber: t.taxIdNumber ?? t.tax_id_number ?? t.taxregistrationNumber ?? '', vatRegistrationNumber: t.vatRegistrationNumber ?? t.vat_registration_number ?? '', taxRegistrationStatus: t.taxRegistrationStatus ?? t.tax_registration_status ?? t.registrationStatus ?? t.registration_status ?? 'registered',
      ...
      exemptionCertificateNumber: t.exemptionCertificateNumber ?? t.exemption_certificate_number ?? t.certificateReference ?? t.certificate_reference ?? '', exemptionExpiryDate: t.exemptionExpiryDate ?? t.exemption_expiry_date ?? t.certificateExpiry ?? t.certificate_expiry ?? '', reverseChargeEligible: !!(t.reverseChargeEligible ?? t.reverse_charge_eligible ?? t.reverseChargeApplicable ?? t.reverse_charge_applicable),
