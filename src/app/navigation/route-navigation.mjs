...
const EXACT_LABELS = {
  ...
  [ROUTES.accountingPnL]: 'Profit & Loss',
  ...
  [ROUTES.vendorPayments]: 'Vendor Payments',
  [ROUTES.vendorPaymentNew]: 'New Vendor Payment',
...
const DETAIL_LABELS = {
  ...
  '/transactions/vendor-payments/': 'Vendor Payment Details',
