...
,
  ...
  accountingTaxGhana: '/accounting/tax/ghana',
  accountingTaxGhanaLedger: '/accounting/tax/ghana/ledger',
  accountingTaxGhanaCatalogProfiles: '/accounting/tax/ghana/catalog-profiles',
  accountingTaxGhanaPartnerProfiles: '/accounting/tax/ghana/partner-profiles',
  accountingTaxGhanaVat: '/accounting/tax/ghana/vat',
  accountingTaxGhanaVatReturn: '/accounting/tax/ghana/vat/return',
  accountingTaxGhanaVatApportionment: '/accounting/tax/ghana/vat/apportionment',
  accountingTaxGhanaImportedServices: '/accounting/tax/ghana/vat/imported-services',
  accountingTaxGhanaImportedServiceDetail: (id=':id') => `/accounting/tax/ghana/vat/imported-services/${id}`,
  accountingTaxGhanaVatReconciliation: '/accounting/tax/ghana/vat/reconciliation',
  accountingTaxGhanaWithholding: '/accounting/tax/ghana/withholding',
  accountingTaxGhanaWithholdingEvents: '/accounting/tax/ghana/withholding/events',
  accountingTaxGhanaWithholdingCertificates: '/accounting/tax/ghana/withholding/certificates',
  accountingTaxGhanaWithholdingReturns: '/accounting/tax/ghana/withholding/returns',
  accountingTaxGhanaWithholdingReturnDetail: (id=':id') => `/accounting/tax/ghana/withholding/returns/${id}`,
  accountingTaxGhanaWithholdingRemittances: '/accounting/tax/ghana/withholding/remittances',
  accountingTaxGhanaWithholdingReconciliation: '/accounting/tax/ghana/withholding/reconciliation',
  accountingTaxGhanaEvat: '/accounting/tax/ghana/evat',
  accountingTaxGhanaEvatDocuments: '/accounting/tax/ghana/evat/documents',
  accountingTaxGhanaEvatDocumentDetail: (id=':id') => `/accounting/tax/ghana/evat/documents/${id}`,
  accountingTaxGhanaEvatQueue: '/accounting/tax/ghana/evat/queue',
  accountingTaxGhanaEvatDevices: '/accounting/tax/ghana/evat/devices',
  accountingTaxGhanaEvatLogs: '/accounting/tax/ghana/evat/logs',
  accountingTaxGhanaEvatSettings: '/accounting/tax/ghana/evat/settings',
  accountingTaxGhanaCit: '/accounting/tax/ghana/cit',
  accountingTaxGhanaCitComputation: (id=':id') => `/accounting/tax/ghana/cit/computations/${id}`,
  accountingTaxGhanaCapitalAllowances: '/accounting/tax/ghana/capital-allowances',
  accountingTaxGhanaIndustryProfile: '/accounting/tax/ghana/industry-profile',
...
,
  ...
  hrPayrollGhana: '/hr/payroll/ghana',
  hrPayrollGhanaReturns: '/hr/payroll/ghana/returns',
  hrPayrollGhanaReturnDetail: (id=':id') => `/hr/payroll/ghana/returns/${id}`,
  hrPayrollGhanaPensions: '/hr/payroll/ghana/pensions',
  hrPayrollGhanaDisengaged: '/hr/payroll/ghana/disengaged',
  hrPayrollGhanaRemittances: '/hr/payroll/ghana/remittances',
  hrLeave: '/hr/leave',
